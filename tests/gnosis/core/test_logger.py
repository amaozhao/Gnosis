"""
Tests for the gnosis.core.logger module.
"""

import os
from unittest import mock

from gnosis.core.logger import configure_logging, get_logger
...
class TestLogger:
    ...
    def test_configure_logging_file_handler(self):
        ...
        with mock.patch("gnosis.core.config.settings") as mock_settings:
            ...
            with mock.patch("logging.FileHandler") as mock_file_handler:
                ...
                with mock.patch("os.makedirs"):
                    ...
                    # Verify handlers are correctly configured in logging.basicConfig
    ...
    def test_get_logger(self):
        ...
        # Verify it's a structlog logger (could be BoundLogger or BoundLoggerLazyProxy)
    ...
    def test_logger_methods(self):
        ...
        # For this test, we'll just verify that the logger has the expected methods
