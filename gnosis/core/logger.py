"""
Logging configuration for the Gnosis application using structlog.
"""
...
def configure_logging() -> None:
    ...
    Sets up logging processors, formatters, and handlers based on application settings.
    Configures structlog to work with standard library logging for third-party libraries.
    """
    ...
    # Try to add callsite information if supported by the installed structlog version
    try:
